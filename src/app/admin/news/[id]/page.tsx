...
export default function NewsArticleViewPage() {
  ...
  const sampleArticle: NewsArticle = {
    ...
    content: `<div class="prose max-w-none">
      <p>एरोग्या पुस्तकालय एवं सेवा संस्था के नए भवन का निर्माण कार्य तेजी से आगे बढ़ रहा है। 35 लाख रुपए की लागत से बन रहा यह आधुनिक पुस्तकालय भवन जून 2024 तक पूर्ण होने की संभावना है।</p>
      ...
      <p>संस्था के अध्यक्ष श्री आत्माराम बोरा ने बताया कि यह भवन न केवल पुस्तकालय सेवा के लिए बल्कि विभिन्न सामाजिक गतिविधियों के लिए भी उपयोग किया जाएगा। निर्माण कार्य 75% पूरा हो चुका है और शेष कार्य अगले महीने तक पूरा हो जाने की संभावना है।</p>
    ...
    keywords: ['पुस्तकालय', 'निर्माण', 'विकास', 'एरोग्या', 'भवन'],
