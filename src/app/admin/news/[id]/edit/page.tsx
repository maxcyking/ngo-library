...
export default function EditNewsPage() {
  ...
  const sampleArticle: NewsArticle = {
    ...
    shortDescription: '65 लाख रुपए की लागत से बन रहे नए पुस्तकालय भवन का निर्माण कार्य तेजी से प्रगति पर है।',
    content: `<p>एरोज्ञा पुस्तकालय एवं सेवा संस्था के नए भवन का निर्माण कार्य तेजी से आगे बढ़ रहा है। 65 लाख रुपए की लागत से बन रहा यह आधुनिक पुस्तकालय भवन जून 2026 तक पूर्ण होने की संभावना है।</p>
...
<li>बच्चों के लिए अलग सेक्शन</li>
    ...
    metaDescription: '65 लाख रुपए की लागत से बन रहे नए पुस्तकालय भवन का निर्माण कार्य तेजी से प्रगति पर है।',
